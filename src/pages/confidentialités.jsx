...
export default function Confidentialite () {
    ...
    return <React.Fragment>
        ...
        <section className="w-full sm:w-2/3 mx-auto flex flex-col justify-center items-center my-5 sm:my-12">
            <div>
                <h1 className="text-4xl sm:m-12 text-center"><strong>politique de confidentialité</strong></h1>
                <p className="text-center text-2xl"><strong>DU SITE&nbsp;: </strong></p>
                <p className="text-center text-2xl"><strong>https://mkz-assurances.fr/</strong></p>
                <p><br /><br /></p>
                <p><strong>ARTICLE 1&nbsp;: PRÉAMBULE<br /><br /></strong></p>
                <p>Cette politique de confidentialité s'applique au site&nbsp;: <span>https://mkz-assurances.fr/</span>. <br /><br /></p>
                ...
                <p><a href="/conditions">https://mkz-assurances.fr/conditions</a></p>
                <p><span><br /></span><strong>ARTICLE 2&nbsp;: PRINCIPES GÉNÉRAUX EN MATIÈRE DE COLLECTE ET DE TRAITEMENT DE DONNÉES</strong><br /><br /></p>
                ...
                <p><br /><strong>ARTICLE 3&nbsp;: DONNÉES À CARACTÈRE PERSONNEL COLLECTÉES ET TRAITÉES DANS LE CADRE DE LA NAVIGATION SUR LE SITE<br /><br /></strong></p>
                <p><strong>A. </strong>DONNÉES COLLECTÉES ET TRAITÉES ET MODE DE COLLECTE</p>
                <p>Les données à caractère personnel collectées sur le site <span id="span_id_nom_du_site_internet"  >MKZ</span> sont les suivantes&nbsp;:</p>
                <p><span id="span_id_liste_donnees_collectees"  >- prénom, nom<br />- adresse email<br />- téléphone</span></p>
                <p>Ces données sont collectées lorsque l'utilisateur effectue l'une des opérations suivantes sur le site&nbsp;:</p>
                <p><span id="span_id_operations_collectes_donnees"  >formulaire de contact</span> </p>
                <p>Le responsable du traitement conservera dans ses systèmes informatiques du site et dans des conditions raisonnables de sécurité l'ensemble des données collectées pour une durée de&nbsp;: <span id="span_id_duree_conservation_donnees"  >1 an</span>.</p>
                <p>La collecte et le traitement des données répondent aux finalités suivantes&nbsp;:</p>
                <p><span id="span_id_finalite_traitement_donnees"  >réponse au demande envoyé via le formulaire de contact</span></p>
                <p>Les traitements de données effectués sont fondés sur les bases légales suivantes&nbsp;:</p>
                <p><span id="span_id_bases_legales"  >- consentement de l'utilisateur</span></p>
                ...
                <p>Le site <span id="span_id_nom_du_site_internet"  >MKZ</span> est hébergé par&nbsp;: <span id="span_id_denomination_sociale_de_l_hebergeur"  >OVH</span>, dont le siège est situé à l'adresse ci-après&nbsp;:</p>
                <p><span id="span_id_siege_social_de_l_hebergeur"  >OVH rue Kellermann 59100 Roubaix</span></p>
                ...
                <p>Le responsable du traitement des données à caractère personnel est&nbsp;: <span id="span_id_prenom_nom_responsable"  >David Pageaux</span>. Il peut être contacté de la manière suivante&nbsp;:</p>
                <p><span id="span_id_methode_contact_rtd"  >par téléphone et mail&nbsp;:<br />- 07 67 56 29 86<br />- david.pageaux@mkz-assurances.fr</span></p>
                ...
                <p><strong>ARTICLE 5&nbsp;: DROITS DE L'UTILISATEUR </strong><br /><br /></p>
                ...
                <p><span id="span_id_procedure_acces_donnees"  >L'utilisateur doit envoyer une demande au responsable des données utilisateurs</span> <br /><br /></p>
                ...
                <p><strong>ARTICLE 6&nbsp;: CONDITIONS DE MODIFICATION DE LA POLITIQUE DE CONFIDENTIALITÉ<br /><br /></strong></p>
                <p>La présente politique de confidentialité peut être consultée à tout moment à l'adresse ci-après indiquée&nbsp;:</p>
                <p><span id="span_id_adresse_politique_confidentialite"  >https://mkz-assurances.fr/politique-de-confidentialité</span></p>
                ...
                <p>Il est porté à la connaissance de l'utilisateur que la dernière mise à jour de la présente politique de confidentialité est intervenue le&nbsp;: <span id="span_id_date_derniere_maj"  class="encours"  >01/08/2023</span>.</p>
            </div>
        </section>
